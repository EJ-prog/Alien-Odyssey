class Alien{
    constructor(game) {
        ...
        this.spritesheet = ASSET_MANAGER.getAsset("./Sprites_and_Assets/character-sprites-player-alien-L.png");
        this.flippedx = 1150;
        ...
        // this.animator = new Animator(this.spritesheet, this.flippedx - 640, 175, -98, 210, 2, 0.5); //duck
        // this.animator = new Animator(this.spritesheet, this.flippedx - 5, 607, -167, 210, 7, 0.2); //holster: after 30 secs of idle, & before jumping
        // this.animator = new Animator(this.spritesheet, this.flippedx - 4, 810, -120, 225, 6, 0.2); //run
